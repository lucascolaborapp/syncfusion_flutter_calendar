...
class DateTimeHelper {
  ...
  static DateTime getNextViewStartDate(
    ...
    switch (calendarView) {
      ...
      case CalendarView.timelineMonth:
        {
          ...
          return numberOfWeeksInView == 6 ||
              ...
              ? (getNextMonthDate(date) as DateTime)
      ...
      case CalendarView.timelineWeek:
      case CalendarView.timelineWorkWeek:
        return addDays(date, DateTime.daysPerWeek) as DateTime;
      case CalendarView.day:
      case CalendarView.timelineDay:
      case CalendarView.schedule:
        return addDays(date, 1) as DateTime;
    }
  }
      ...
      case CalendarView.timelineMonth:
        {
          return numberOfWeeksInView == 6 ||
                  calendarView == CalendarView.timelineMonth
              ? (getPreviousMonthDate(date) as DateTime)
              : addDays(date, -numberOfWeeksInView * DateTime.daysPerWeek)
                  as DateTime;
        }
      case CalendarView.timelineWeek:
  ...
  static DateTime _getPreviousValidDate(
    ...
    DateTime previousDate = addDays(prevViewDate, -1) as DateTime;
    while (nonWorkingDays.contains(previousDate.weekday)) {
      previousDate = addDays(previousDate, -1) as DateTime;
    }
    return previousDate;
  }
  ...
  static DateTime _getNextValidDate(
    ...
    DateTime nextViewDate = addDays(nextDate, 1) as DateTime;
    while (nonWorkingDays.contains(nextViewDate.weekday)) {
      nextViewDate = addDays(nextViewDate, 1) as DateTime;
    }
    return nextViewDate;
  }
      ...
      case CalendarView.timelineMonth:
        {
          if (numberOfWeeksInView != 6 ||
            ...
            final DateTime prevViewDate =
                addDays(visibleDates[0], -1) as DateTime;
            ...
            final DateTime previousDate =
                getPreviousMonthDate(currentDate) as DateTime;
      ...
      case CalendarView.timelineWeek:
        {
          ...
          prevViewDate = addDays(prevViewDate, -1) as DateTime;
          if (!isSameOrAfterDate(minDate, prevViewDate)) {
            return false;
          }
        }
      ...
      case CalendarView.timelineMonth:
        {
          if (numberOfWeeksInView != 6 ||
            ...
            final DateTime nextViewDate =
                addDays(visibleDates[visibleDates.length - 1], 1) as DateTime;
            if (!isSameOrBeforeDate(maxDate, nextViewDate)) {
              return false;
            }
          } else {
            final DateTime currentDate = visibleDates[visibleDates.length ~/ 2];
            final DateTime nextDate = getNextMonthDate(currentDate) as DateTime;
