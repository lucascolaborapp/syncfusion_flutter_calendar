...
class MonthViewSettings with Diagnosticable {
  ...
  bool operator ==(dynamic other) {
    ...
    final MonthViewSettings otherSetting = other as MonthViewSettings;
...
class AgendaStyle with Diagnosticable {
  ...
  bool operator ==(dynamic other) {
    ...
    final AgendaStyle otherStyle = other as AgendaStyle;
...
class MonthCellStyle with Diagnosticable {
  ...
  bool operator ==(dynamic other) {
    ...
    final MonthCellStyle otherStyle = other as MonthCellStyle;
