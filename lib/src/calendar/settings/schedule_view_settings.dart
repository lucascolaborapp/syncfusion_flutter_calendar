...
class ScheduleViewSettings with Diagnosticable {
  ...
  bool operator ==(dynamic other) {
    ...
    final ScheduleViewSettings otherStyle = other as ScheduleViewSettings;
...
class MonthHeaderSettings with Diagnosticable {
  ...
  bool operator ==(dynamic other) {
    ...
    final MonthHeaderSettings otherStyle = other as MonthHeaderSettings;
...
class WeekHeaderSettings with Diagnosticable {
  ...
  bool operator ==(dynamic other) {
    ...
    final WeekHeaderSettings otherStyle = other as WeekHeaderSettings;
...
class DayHeaderSettings with Diagnosticable {
  ...
  bool operator ==(dynamic other) {
    ...
    final DayHeaderSettings otherStyle = other as DayHeaderSettings;
