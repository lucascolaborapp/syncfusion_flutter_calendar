...
class _CalendarViewState extends State<_CalendarView>
  ...
  Widget _addAllDayAppointmentPanel(
    ...
    final Color borderColor = widget.calendar.cellBorderColor ??
        (calendarTheme.cellBorderColor ?? Colors.black);
...
class _ViewHeaderViewPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    /// calendar.
    final TextStyle viewHeaderDayStyle = viewHeaderStyle.dayTextStyle ??
        (calendarTheme.viewHeaderDayTextStyle ?? const TextStyle());
    final TextStyle viewHeaderDateStyle = viewHeaderStyle.dateTextStyle ??
        (calendarTheme.viewHeaderDateTextStyle ?? const TextStyle());
...
class _TimeRulerView extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final TextStyle timeTextStyle = timeSlotViewSettings.timeTextStyle ??
        (calendarTheme.timeTextStyle ?? TextStyle());
